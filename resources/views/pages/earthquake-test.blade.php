    ...
    <section class="pt-60 pb-32 bg-[#006272] text-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 text-center">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-4xl md:text-7xl font-bold mb-8 reveal-up uppercase tracking-tight">BİNANIZ GÜVENDE Mİ?</h1>
                <div class="w-32 h-1.5 bg-white mx-auto mb-10 rounded-full reveal-up"></div>
                <p class="text-xl md:text-2xl text-white/90 leading-relaxed font-light reveal-up">Deprem gerçeğiyle
    ...
    <section class="py-24 bg-gray-50 relative">
        <div class="container mx-auto px-6">
            <div class="max-w-5xl mx-auto">
                <div
                    class="bg-white p-8 md:p-16 rounded-[3rem] shadow-2xl reveal-up border border-gray-100 flex flex-col lg:flex-row gap-16">
                    <div class="lg:w-1/2">
                        <h2 class="text-3xl font-bold text-primary mb-8 uppercase tracking-wider">TEST BAŞVURU FORMU</h2>
                        <p class="text-gray-500 mb-10 leading-relaxed">Aşağıdaki formu doldurarak binanız için ücretsiz ön
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center space-x-4">
                                ...
                                <span class="font-bold text-dark">+90 212 000 00 00</span>
                            </div>
                            <div class="flex items-center space-x-4">
                                <div
                                    class="w-12 h-12 bg-primary/5 rounded-2xl flex items-center justify-center text-primary">
                                ...
                                <span class="font-bold text-dark">destek@imkandev.com</span>
                            </div>
                        </div>
                    </div>
